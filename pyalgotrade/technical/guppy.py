...
"""
.. moduleauthor:: Pranav Shirsul <techpranav@gmail.com>
"""
...
class GUPPY(dataseries.SequenceDataSeries):
    """
    ...
    :type maxLen: int.
    """
    def __init__(self, dataSeries, short_periods,long_periods, maxLen=None):
        super(GUPPY, self).__init__(maxLen)
